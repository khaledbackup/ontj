         ...
         <header class="tech-header header">
            <div class="container-fluid">
                <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                    ...
                    <a class="navbar-brand" href="tech-index.html"><img src="images/logo2.png" height ="70px" alt=""/></a>
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown has-submenu menu-large hidden-md-down hidden-sm-down hidden-xs-down">
                               <Link to="/news"> <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">News</a></Link>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="tech-category-02.html">Reviews </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="tech-category-03.html">Videos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="tech-category-03.html">MOUVMA</a>
                            </li>
                            <li class="nav-item">
